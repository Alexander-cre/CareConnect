...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Add your form submission logic here (e.g., API call, email send)
    ...
    <div className="bg-gray-50 dark:bg-gray-900" id="contact">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          ...
          <div className="flex items-center mt-8 space-x-2 text-gray-600 dark:text-gray-400">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <textarea
                ...
                onChange={handleChange}
                rows={4} // Equivalent to h-36 for better accessibility
              />
            </div>
            <button
              type="submit"
              className="w-full py-4 font-semibold text-white transition-colors bg-cyan-800 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-gray-200 px-7 dark:bg-white dark:text-black"
            >
              Send Message
            </button>
          </form>
